...
summary: "OpenTF has forked Terraform in response to HashiCorp's license change, aiming to maintain an open-source, community-driven version with the support of numerous companies and individuals."
---
